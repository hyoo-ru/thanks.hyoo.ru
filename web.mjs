...
;
	($.$hyoo_thanks_app) = class $hyoo_thanks_app extends ($.$mol_book2_catalog) {
		Source(){
		...
		Wallet_balance(id){
			...
			(obj.sub) = () => ([(this?.Wallet_icon()), (this?.wallet_balance())]);
			return obj;
		}
		subscription(next){
			if(next !== undefined) return next;
		...
		Awaiting(){
			...
			(obj.tools) = () => ([(this?.Wallet_balance("0"))]);
			(obj.body) = () => ([(this?.Subscription_block()), (this?.Awaiting_targets_block())]);
			return obj;
		}
		wallet_label(){
		...
		Wallet_block(){
			const obj = new this.$.$mol_labeler();
			(obj.label) = () => ([(this?.wallet_label()), (this?.Wallet_copy())]);
		...
		Import_deck(){
			...
			(obj.content) = () => ([(this?.Import_words()), (this?.Import_button())]);
			return obj;
		}
		export_words(){
			return "";
		...
		Wallet_page(){
			...
			(obj.tools) = () => ([(this?.Wallet_balance("1"))]);
			(obj.body) = () => ([(this?.Deck())]);
			return obj;
		}
		story_text(){
		...
		Target(){
			...
			(obj.body) = () => ([(this?.Target_likes()), (this?.target_hint())]);
			return obj;
		}
		spreads(){
			return {
	...
	($mol_mem(($.$hyoo_thanks_app.prototype), "Source"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Lights"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Theme"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "target_likes"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Target_likes"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "target_hint"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Welcome_text"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Welcome"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_icon"));
	($mol_mem_key(($.$hyoo_thanks_app.prototype), "Wallet_balance"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "subscription"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Subscription"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Subscription_block"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Awaiting_targets"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Awaiting_targets_block"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Awaiting"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_copy"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_address"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_block"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_deck"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "import_words"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Import_words"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "import_wallet"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Import_button"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Import_deck"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Export_words"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Export_deck"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Deck"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Wallet_page"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Story_text"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Story"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "target"));
	($mol_mem(($.$hyoo_thanks_app.prototype), "Target"));
	($.$hyoo_thnaks_app_likes) = class $hyoo_thnaks_app_likes extends ($.$mol_number) {
		dec_icon(){
	...
	($mol_mem(($.$hyoo_thnaks_app_likes.prototype), "dec_icon"));
	($mol_mem(($.$hyoo_thnaks_app_likes.prototype), "inc_icon"));
